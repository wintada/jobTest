...
const itemslibrary = () => {
  ...
  const [bgcolour, setbgcolour] = useState("gray300");
  ...
  //   const Openimglibrary = () => setimglibraryDialog(!imglibraryDialog);
  ...
  const checkboxMybusiness = () => {
    ...
    if (mybusinessCB?.checked == true) {
      setMyBusinesscheck(true);
      locationCB.checked = true;
      setLocationscheck(true);
      setLocationinput("My Business");
      if (mybusinessCB?.checked == true && aaaflCB?.checked == true) {
        input?.setAttribute("disabled", "");
        setMyBusinesscheck(true);
        locationCB.checked = true;
        setLocationscheck(true);
    ...
    } else if (mybusinessCB?.checked == false && aaaflCB?.checked == true) {
      input?.removeAttribute("disabled");
      setMyBusinesscheck(false);
      setAvailableatallfuturelocations(true);
      locationCB.checked = true;
