...
const itemslibrary = () => {
  ...
  const handleOpenaddUn = (value) => {
    setOpenaddUn(!openaddUn), setSize3(value);
  };
  const handleOpenV = () => {
  ...
  const handleOpenE = (value) => {
    setOpenedit(!openedit), setSize(value), settab(value);
  };
  const handleOpenadd = () => setOpenaddva(!openaddva);
  const handleOpenaddS = (value) => {
    setOpenaddS(!openaddS), setSize2(value);
  };
  const handleOpenaddatt = () => setOpenaddatt(!openaddatt);
  ...
  return (
    <>
      <div>
          ...
          <DialogBody divider>
            <div>
              ...
              <div>
                ...
                <Input size="lg" label="Add option" />
              </div>
            </div>
          </DialogBody>
          <DialogFooter>
                ...
                <TabPanel value="1">
                  <div className="w-full">
                    ...
                    <div className="flex flex-col ">
                      ...
                      <Select size="lg" onChange={() => handleOpenaddUn("md")}>
                ...
                <TabPanel value="3">
                  <div className="flex flex-col w-full">
                    ...
                    <Typography variant="small">
                      ...
                      checkout and reports. Remove a unit or edit precision in
                      Items {">"} Units.
                    </Typography>
                  </div>
                </TabPanel>
        ...
        {/* Edit variations add stock */}
        {/* <Dialog open={size2 === "lg"} handler={handleOpenaddS} size={size2 || "md"} className="overflow-visible">
            <DialogHeader>
                <div>
                Edit variations
                </div>
            ...
            <div className='w-full'>
                ...
                <Typography variant="h6">Locations and stock</Typography>
                <div>
                <Checkbox defaultChecked /><a>Available at 1 of 1 locations</a>
                </div>
                </div>
                <div className='border border-current'>
                <Checkbox defaultChecked /><a>Available at My Business</a>
                </div>
                <div className='border border-t-0 border-current'>
                <Switch id="Tracking" label="Tracking" />
                </div>
                ...
                <div className='border border-t-0 border-current'>
                    <Switch id="Mark" label="Mark as sold out on Point of Sale and Online" />
                </div>
            </div>
            </DialogBody>
            <DialogFooter>
          <Button variant="gradient" color="green" onClick={handleOpenaddS}>
            <span>Done</span>
          </Button>
        </DialogFooter>
        </Dialog> */}
        {/* Add a Unit */}
        <Dialog open={size3 === "md"} handler={handleOpenaddUn} size={size3 || "md"} className="overflow-visible">
            <DialogHeader>
                <div>
                Add a Unit
                </div>
            ...
            <div>
              <Typography variant="h6">Precision</Typography>
                ...
                <Typography variant="small">
                Precision is the number of decimal places that appear in checkout and reports. Remove a unit or edit precision in Items {'>'} Units.
                </Typography>
            </div>   
            </DialogBody>
            <DialogFooter>
