...
const Options = () => {
  ...
  const handleOpenE = (value) => {setOpenedit(!openedit),{variationdata},console.log(variationdata),setSize(value),settab(value)};
  const handleOpenadd = () => {setOpenaddva(!openaddva),{variationdata},console.log(variationdata)};
   
  const handleOpenaddatt = (value) => {setOpenedit(!openedit),setSize(value),setOpenaddatt(!openaddatt)};
      ...
      <div>
          ...
          <DialogBody divider>
            <div>
              ...
              <div>
                ...
                <Input size="lg" label="Add option" onChange={(e)=>setoption(e.target.value)} onBlur={inputOption}/>
                {arr.map((todo,index) =>{
                    return(
                        <Input key={index} size="lg" label="Add option" onChange={(e)=>setoption(e.target.value)} onBlur={inputOption}/>
                    )
                })}
              </div>
            </div>
              ...
              <div className="divide-y-2 divide-slate-400 ">
                ...
                <div>
                  {clonet.map((todo,index)=> {
                    return(
                        <Checkbox key={todo}label={clonet[index]} />
                    )
                  })}
                </div>
              </div>
                ...
                <TabPanel value="1">
                  <div className="w-full">
                    ...
                    <div className="flex flex-col ">
                      ...
                      <Input placeholder="฿0.00" onChange={(e) => setPrice(e.target.value)}/>
                    </div>
        ...
        <div>
          ...
          <div className="flex w-1/2">
            ...
            />
            <Select size="lg" label="Location" value={location} onChange={value=>handleChange(value)}>
